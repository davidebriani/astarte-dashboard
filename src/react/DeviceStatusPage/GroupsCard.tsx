...
const GroupsTable = ({ groups, onAddToGroupClick }: GroupsTableProps): React.ReactElement => (
  <Table>
    <thead>
      <tr>
        <th>Name</th>
...
const GroupsCard = ({ device }: GroupsCardProps): React.ReactElement => {
  return (
    <FullHeightCard xs={12} md={6} className="mb-4">
      ...
      <Card.Body className="d-flex flex-column">
        ...
        <div className="mt-auto">
          <Button variant="primary" onClick={onAddToGroupClick}>Add to existing group</Button>
        </div>
      </Card.Body>
    </FullHeightCard>
  );
