...
): AstarteChartProvider<AstarteChartSingleValue<
  AstarteChartValueIndividualTimestamped
> | null> => ({
  ...
  async getData() {
    ...
    return _.minBy(data, 'data.value') || null;
  },
});

export const getMinOperator = (): AstarteChartOperator<
  AstarteChartProvider<AstarteChartListValue<AstarteChartValueIndividualTimestamped>>,
  AstarteChartProvider<AstarteChartSingleValue<AstarteChartValueIndividualTimestamped> | null>
> => {
  return minOperator.bind(null);
};
